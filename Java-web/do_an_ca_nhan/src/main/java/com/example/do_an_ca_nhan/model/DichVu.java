...
public class DichVu {
    ...
    public DichVu(int maDichVu, String tenDichVu, int dienTich, double chiPhiThue, int soNguoiToiDa, int maKieuThue, int maLoaiDichVu, String tieuChuanPhong, String moTaTienNghiKhac, double dienTichHoBoi, int soTang, String trangThai) {
